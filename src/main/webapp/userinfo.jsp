...
<body>
    ...
    <div class="container">
    	...
    	<form action="user-info" method="post" name="form-info" id="myForm">
    		...
    		<table style="width: 60%; margin: 0 auto;">
				<tr>
					<th>Name:</th>
					<td><input type="text" class="input-focus" placeholder="Nguyen Van A" name="name" value="${user.getName()}" required maxlength="50"></td>
				</tr>
				<tr>
					<th>Email:</th>
					<td><input type="text" class="input-focus" placeholder="e@mail.com" name="email" value="${user.getEmail()}" required maxlength="50"></td>
				</tr>
				<tr>
					<th>Room:</th>
					<td><input type="text" class="input-focus" placeholder="A102" name="room" value="${user.getRoom()}" required  maxlength="10" readonly></td>
				</tr>
				<tr>
					<th>Student ID:</th>
					<td><input type="text" class="input-focus" placeholder="102190222" name="mssv" value="${user.getMssv()}" readonly></td>
				</tr>
				<tr>
					<th>Username:</th>
				...
				<tr>
					<td colspan="2">
						<button class="btn" type="submit" style="margin:auto"><i class="far fa-save"></i> Save changes</a></button>
					</td>
				</tr>
			</table>
		</form>
