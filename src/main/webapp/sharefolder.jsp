...
<body>
    ...
    <div class="container">
    	<div class="main">
    		...
    		<form action="share-folder" method="post" style="margin-top: 15px; text-align: center;" name="shareform">
    			<input type="hidden" value="${folder.getFolderID()}" name="folder-id">
    			Sharing Mode: 
    			...
    			<p>Link: <input type="text" value="${myuri}?folder-id=${folder.getFolderID()}"  style="padding: 10px; width: 40%; display:inline" readonly></p>
